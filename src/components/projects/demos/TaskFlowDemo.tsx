        ...
        {TABS.map((tab) => {
          ...
          return (
            <button
              ...
              className={`rounded-full px-3 py-1.5 text-sm font-medium font-mono transition-colors focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#f8c946] ${
                selected
...
function SignupPanel() {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4" noValidate>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div className="space-y-1.5">
          ...
          <input
            ...
            className="w-full rounded-lg border border-white/10 bg-[#1e1e1e] px-3 py-2 text-sm text-white placeholder-white/30 focus:outline-none focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#f8c946]"
          />
        </div>
        <div className="space-y-1.5">
      ...
      <label htmlFor={duplicateId} className="flex items-center gap-2 text-sm text-white/60">
        <input
          id={duplicateId}
          type="checkbox"
